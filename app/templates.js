...
function program1(depth0,data) {
  ...
  data.buffer.push(">Reverse Geocode<br>Address from Lat Long</button>\n			</div>\n		</div>\n	</div>\n\n	<div class=\"row\">\n		<div class=\"large-2 columns\">\n			 <label for=\"latitude\" class=\"right inline\">Comments</label>\n		</div>\n		<div class=\"large-10 columns\">\n			");
...
Ember.TEMPLATES["calls-table"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
